...
function renderPlaylist(data) {
    ...
    <tbody class="align-middle">                
      ...
      <td class="col-8">
        <div id=${item.id} class="d-flex gap-3 align-items-center"><img class="icon-album-search" src="${item.album.images[1].url}"/>
