...
if (inputPhoto) {
    ...
    formPhoto.addEventListener('submit', (e) => {
        ...
        if (inputPhoto.files) {
            ...
            formData.append('photo', imgPreview.src);
