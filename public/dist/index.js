...
async function toggleFollowArtist() {
    if (btnFollowArtist === null || btnFollowArtist === void 0 ? void 0 : btnFollowArtist.classList.contains('active')) {
        ...
        if (res.data.status === 'success') {
            console.log('artist was unfollow');
            window.setTimeout(() => {
                location.assign('/');
            }, 1500);
        }
