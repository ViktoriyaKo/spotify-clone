            ...
            if (target.classList.contains('active-icon')) {
                ...
                if (res.data.status === 'success') {
                    if (amountTracks) {
                        ...
                        amountTracks.textContent = `${parseInt(text) - 1} tracks`;
                    }
