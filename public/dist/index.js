...
if (inputPhoto) {
    ...
    btnSetPhoto.addEventListener('click', () => {
        if (inputPhoto.files) {
            ...
            (0, login_1.setPhoto)(inputPhoto.files[0]);
        }
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setPhoto = exports.signup = exports.login = void 0;
    ...
    try {
        ...
        if (res.data.status === 'success') {
            ...
            if (info) {
                ...
                info.innerHTML = '<div class="info"><h2>Your photo is saved</h2></div>';
                setTimeout(() => {
