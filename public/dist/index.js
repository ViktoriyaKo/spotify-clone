...
async function toggleSavedAlbum() {
    if (btnAlbumLike === null || btnAlbumLike === void 0 ? void 0 : btnAlbumLike.classList.contains('active')) {
        ...
        if (res.data.status === 'success') {
            ...
            popupMessage === null || popupMessage === void 0 ? void 0 : popupMessage.classList.add('active');
            window.setTimeout(() => {
                popupMessage === null || popupMessage === void 0 ? void 0 : popupMessage.classList.remove('active');
            }, 3000);
        }
    }
    else {
